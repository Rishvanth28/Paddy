...
def onboard(request):
    return render(request, "onboarding_app/onboard.html")
...
def create_admin(request):
    if request.method == "POST":
        ...
        if AdminTable.objects.filter(email=email).exists():
            ...
            return redirect("onboarding_app:onboard")
...
def create_customer(request):
    ...
    if request.method == "POST":
        ...
        if current_customer_count >= admin.user_count:
            ...
            return redirect("onboarding_app:onboard" if is_superadmin else "onboarding_app:customer_onboard_view")
    ...
    return render(request, "onboarding_app/onboard.html" if is_superadmin else "onboarding_app/customer_onboard.html")
...
def customer_onboard_view(request):
    return render(request, "onboarding_app/customer_onboard.html")
